...
public class OVRSceneVolumeEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        using (new EditorGUI.DisabledScope(true))
        {
            ...
            EditorGUILayout.Vector3Field(nameof(_object.Dimensions), _object.Dimensions);
            EditorGUILayout.Vector3Field(nameof(_object.Offset), _object.Offset);
        }
